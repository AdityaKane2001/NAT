...
@register_model
def nat_s_tiny(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
        embed_dim=96,
...
@register_model
def nat_s_small(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[3, 6, 12, 24],
        embed_dim=96,
...
@register_model
def nat_s_base(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=128,
...
@register_model
def nat_s_large(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
...
@register_model
def nat_s_large_384(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
...
@register_model
def nat_s_large_21k(pretrained=False, **kwargs):
    model = NAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
