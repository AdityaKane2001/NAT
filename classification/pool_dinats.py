...
model_urls = {
    # ImageNet-1K
    "pool_dinat_s_tiny_1k": "",
    "pool_dinat_s_small_1k": "",
    "pool_dinat_s_base_1k": "",
    "pool_dinat_s_large_1k": "",
    "pool_dinat_s_large_1k_384": "",
    # ImageNet-22K
    "pool_dinat_s_large_21k": "",
}
...
@register_model
def pool_dinat_s_tiny(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
        embed_dim=96,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_tiny_1k"]
...
@register_model
def pool_dinat_s_small(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[3, 6, 12, 24],
        embed_dim=96,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_small_1k"]
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        model.load_state_dict(checkpoint)
    return model
...
@register_model
def pool_dinat_s_base(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=128,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_base_1k"]
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        model.load_state_dict(checkpoint)
    return model
...
@register_model
def pool_dinat_s_large(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_large_1k"]
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        model.load_state_dict(checkpoint)
    return model
...
@register_model
def pool_dinat_s_large_384(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_large_1k_384"]
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        model.load_state_dict(checkpoint)
    return model
...
@register_model
def pool_dinat_s_large_21k(pretrained=False, **kwargs):
    model = DiNAT_s(
        depths=[2, 2, 18, 2],
        num_heads=[4, 8, 16, 32],
        embed_dim=192,
    ...
    if pretrained:
        url = model_urls["pool_dinat_s_large_21k"]
        checkpoint = torch.hub.load_state_dict_from_url(url=url, map_location="cpu")
        model.load_state_dict(checkpoint)
    return model
