...
def compute_r_sched(num_layers: int, start_t: int, end_t: int):
    target_num_tokens = np.round(np.linspace(start_t, end_t, num=num_layers + 1, dtype=int))
    # print(target_num_tokens)
    return target_num_tokens[:-1] - target_num_tokens[1:]